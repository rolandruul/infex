        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            ...
            <div className="space-y-3 text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
                  <path fillRule="evenodd" d="M5.25 9a6.75 6.75 0 0113.5 0v.75c0 2.123.8 4.057 2.118 5.477a.75.75 0 01-.297 1.206c-1.544.57-3.16.99-4.831 1.243V3.75a.75.75 0 011.5 0V9a6.75 6.75 0 0113.5 0v.75c0 2.123.8 4.057 2.118 5.477a.75.75 0 01-.297 1.206c-1.544.57-3.16.99-4.831 1.243V3.75a.75.75 0 011.5 0v10.5a1.5 1.5 0 01-1.5 1.5H4.5a1.5 1.5 0 01-1.5-1.5V3.75a.75.75 0 011.5 0v10.5c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125H3a.75.75 0 010-1.5h.375v-1.5A.75.75 0 013 15h18a.75.75 0 01-.375.675v1.5H21a.75.75 0 010 1.5h-1.125A1.125 1.125 0 0118.75 18v-1.5h.375a.75.75 0 010 1.5H3z" clipRule="evenodd" />
                </svg>
              </div>
